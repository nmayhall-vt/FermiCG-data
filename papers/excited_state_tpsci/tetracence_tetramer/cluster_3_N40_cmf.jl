...
e_cmf, U_cmf, d1  = ClusterMeanField.cmf_oo_diis(ints_sorted, clusters, init_fspace, RDM1(rdm1, rdm1),
                                        verbose=0, tol_oo=1e-7, tol_d1=1e-7, tol_ci=1e-8, diis_start=3);

C_cmf = C_sorted * U_cmf
ints_cmf = orbital_rotation(ints_sorted, U_cmf);
#@save  "cmf_diis.jld2" ints_cmf d1 clusters init_fspace C_cmf
#FermiCG.pyscf_write_molden(mol,C_cmf,filename="cmf_diis_orbs.molden");
